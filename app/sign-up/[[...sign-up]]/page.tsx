...
export default function SignUpPage(){
  useEffect(() => {
    const setPlaceholders = () => {
      ...
      if (firstNameInput) firstNameInput.placeholder = 'Omar';
      if (lastNameInput) lastNameInput.placeholder = 'Elhawwari';
        ...
        <div className="flex flex-col gap-6">
          <div className='retro-window' style={{
            ...
            <div style={{padding: '32px', textAlign: 'center', position: 'relative'}}>
              ...
              <h1 style={{
                ...
                textShadow: '3px 3px 0 rgba(0, 0, 0, 0.8), 6px 6px 0 var(--retro-cyan), 9px 9px 0 var(--retro-primary)',
                letterSpacing: '3px',
                marginBottom: '16px',
              ...
              <div className='retro-status'>
                <span>PLAYER: NEW</span>
                <span>LEVEL: 0</span>
                <span style={{animation: 'blink 1s infinite'}}>READY!</span>
              </div>
            </div>
          </div>
          ...
          <div className='retro-window hidden lg:block' style={{
            ...
            <div className="p-4 md:p-5 text-center">
              <p className="text-[9px] md:text-[10px] font-bold leading-[1.8] tracking-[1px]" style={{
                color: 'var(--retro-primary)',
                textShadow: '1px 1px 0 rgba(0, 0, 0, 0.3)'
              }}>
                ALREADY HAVE AN ACCOUNT? <br/> <a href="/sign-in" style={{
          ...
          <div className='retro-window hidden lg:block' style={{
            background: 'linear-gradient(135deg, rgba(255, 0, 136, 0.05) 0%, rgba(255, 0, 255, 0.05) 100%)'
          }}>
